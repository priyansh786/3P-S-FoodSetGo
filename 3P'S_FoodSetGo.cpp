...
int main()
{
    ...
    outtextxy(420,300,"3P'S FoodSetGo");
    settextstyle(10,HORIZ_DIR,5);
    outtextxy(60,490,"Created BY:");
    outtextxy(60,550,"Priyansh Nigam");
    getch();
    closegraph();
    ...
    setcolor(BLUE);
    settextstyle(8,0,4);
    outtextxy(0,0,"Burger King");
    setcolor(YELLOW);
    outtextxy(390,0,"Mcdonalds");
    setcolor(WHITE);
    outtextxy(634,0,"Dominos");
    setcolor(RED);
    outtextxy(980,0,"Pizza Hut");
    setcolor(GREEN);
    outtextxy(1260,0,"Subway");
